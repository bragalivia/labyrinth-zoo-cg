...
public class CarregaOBJ {
    private String OBJModelPath; 
    private ArrayList vData = new ArrayList(); 
    private ArrayList vtData = new ArrayList(); 
    private ArrayList vnData = new ArrayList(); 
    ...
    public CarregaOBJ(String Modelpath) {
